...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    'd738b878001f4662bef7107720f8d81c,en:d738b878001f4662bef7107720f8d81c',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 1991, // e.g if leave this empty, current year will be used.
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个沉浮于人间的普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ikun.su//', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20250081号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20250081', // 备案查询链接，如果用了萌备等备案请在这里填写
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名艺术家, Hi，我是一名设计师,Hi，我是一个打工人,欢迎来到我的博客🎉',
