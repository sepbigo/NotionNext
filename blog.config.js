...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一名艺术工作者, Hi，我是一个搬砖人,Hi，我是一个终生学习的人,欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '团子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个沉浮于红尘之中的人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ikun.su/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '学习, 博客, 记录, 生活', // 网站关键词 英文逗号隔开，

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'sep@aya.yale.edu', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || 'https://weibo.com/u/5190339416', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/sepbigo', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  CONTACT_INSTAGRAM: process.env.NEXT_PUBLIC_CONTACT_INSTAGRAM || 'https://www.instagram.com/sep_bigbabyer/', // 您的instagram地址
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/8450596', // B站主页
  CONTACT_YOUTUBE: process.env.NEXT_PUBLIC_CONTACT_YOUTUBE || 'https://www.youtube.com/@henryart3312', // Youtube主页
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://cz.ikun.su/file/4a83cb91438ef3c5501e5.png', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  RANDOM_IMAGE_URL: process.env.NEXT_PUBLIC_RANDOM_IMAGE_URL || 'https://www.ani-nya.com/rdmpng/unlock.php', // 随机图片API,如果未配置下面的关键字，主页封面，头像，文章封面图都会被替换为随机图片
